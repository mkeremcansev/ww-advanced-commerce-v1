                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">@lang('words.coupon_edit')</h4>
                            </div>
                            <form method="POST" action="{{ route('panel.coupon.update', $coupon->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="usage" value="{{ $coupon->usage }}">
                                    </div>
