                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">@lang('words.story_edit')</h4>
                                </div>
                                <form method="POST" action="{{ route('panel.story.update', $story->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="repeater">
                                        <div class="card-body">
                                            ...
                                            <div data-repeater-list="stories">
                                                @foreach ($story->getAllStoryAttributes as $a)
