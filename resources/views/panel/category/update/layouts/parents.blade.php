@foreach ($getAllSubCategoriesCollection as $c)
    ...
    @if (count($c->getAllCategoriesCollection) > 0)
        @include('panel.category.update.layouts.parents', ['getAllSubCategoriesCollection' => $c->getAllCategoriesCollection, 'parent_title' =>$parent_title.__('words.separator'). $c->title])
    @endif
@endforeach
