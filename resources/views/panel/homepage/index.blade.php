                                    ...
                                    <div class="col-md-12 col-sm-6 col-12 mb-2 mb-md-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">@lang('words.week_earnings', ['price'=>getMoneyOrder($week)])</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-6 col-12 mb-2 mb-md-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">@lang('words.month_earnings', ['price'=>getMoneyOrder($month)])</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
