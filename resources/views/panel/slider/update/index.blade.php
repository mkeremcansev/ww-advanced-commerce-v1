                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">@lang('words.slider_edit')</h4>
                                </div>
                                <form method="POST" action="{{ route('panel.slider.update', $slider->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
