                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">@lang('words.admin_list')</h4>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <a class="dropdown-item text-success" href="{{ route('panel.user.review.show', $a->id) }}">@lang('words.detail')</a>
                                                                <a class="dropdown-item text-danger" href="{{ route('panel.admin.destroy', $a->id) }}">@lang('words.delete')</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
