<html>
 <head> 
  ...
  <title><?php echo app('translator')->get('words.website_maintenance_text'); ?></title> 
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/4.2.0/normalize.min.css" media="all" onload="if(media!='all')media='all'"> 
  <link href="https://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300ita​lic,400italic,500,500italic,700,700italic,900italic,900" rel="stylesheet" type="text/css" media="all" onload="if(media!='all')media='all'"> 
    <?php echo $__env->make('errors.style.style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 </head> 
 <body> 
  <div class="warning-content"> 
   <h1 class="title"><?php echo app('translator')->get('words.website_maintenance_text'); ?></h1> 
    ...
    <g id="large"> 
     <g transform="rotate(8 31 37)"> 
      <path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
       ...
       c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="<?php echo e(setting('primary')); ?>"></path> 
     ...
     <g id="small" transform="rotate(-12 78 21)"> 
        ...
        C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="<?php echo e(setting('primary')); ?>">
        </path> 
   ...
   <p><?php echo e(setting('mail')); ?></p> 
   <p> </p> 
  </div> 
 </body>
</html><?php /**PATH /home/vagrant/code/eticaretim/resources/views/errors/503.blade.php ENDPATH**/ ?>