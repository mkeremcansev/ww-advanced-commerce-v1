...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('Panel/app-assets/css/core/menu/menu-types/horizontal-menu.css')); ?>" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('Panel/app-assets/css/plugins/extensions/ext-component-toastr.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('Panel/assets/css/style.css')); ?>" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('Panel/app-assets/vendors/css/forms/select/select2.min.css')); ?>" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('Panel/app-assets/vendors/css/tables/datatable/dataTables.bootstrap4.min.css')); ?>" />
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('Panel/app-assets/vendors/css/pickers/pickadate/pickadate.css')); ?>">
    <link rel="stylesheet" type="text/css"
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="<?php echo e(route('panel.category.index')); ?>" data-toggle="dropdown">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item d-flex align-items-center"
                                    href="<?php echo e(route('panel.product.index')); ?>" data-toggle="dropdown">
                                    <i data-feather="chevrons-right"></i>
