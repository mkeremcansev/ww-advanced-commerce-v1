                            ...
                            <form method="POST" action="<?php echo e(route('panel.coupon.store')); ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="title"><?php echo app('translator')->get('words.coupon_code'); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/eticaretim/resources/views/panel/coupon/create/index.blade.php ENDPATH**/ ?>