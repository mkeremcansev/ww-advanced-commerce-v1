...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('words.page_list'); ?>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title"><?php echo app('translator')->get('words.page_list'); ?></h4>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <a class="dropdown-item text-success" href="<?php echo e(route('panel.page.edit', $p->id)); ?>"><?php echo app('translator')->get('words.edit'); ?></a>
                                                                <form action="<?php echo e(route('panel.page.destroy', $p->id)); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/eticaretim/resources/views/panel/page/index.blade.php ENDPATH**/ ?>