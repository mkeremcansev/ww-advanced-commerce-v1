    ...
    <div class="container">
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
            ...
            <?php ($product = $r->getOneProductAttributes); ?>
                <div class="col">
                    <div class="product-card <?php echo e(getStockControl($r->getAllProductVariants)); ?>">
...
</section><?php /**PATH C:\laragon\www\eticaretim\resources\views/web/homepage/layouts/product.blade.php ENDPATH**/ ?>