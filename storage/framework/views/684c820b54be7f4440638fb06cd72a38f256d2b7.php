...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('words.admin_list'); ?>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title"><?php echo app('translator')->get('words.admin_list'); ?></h4>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <a class="dropdown-item text-success" href="<?php echo e(route('panel.user.review.show', $a->id)); ?>"><?php echo app('translator')->get('words.detail'); ?></a>
                                                                <a class="dropdown-item text-danger" href="<?php echo e(route('panel.admin.destroy', $a->id)); ?>"><?php echo app('translator')->get('words.delete'); ?></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/eticaretim/resources/views/panel/user/admin/index.blade.php ENDPATH**/ ?>