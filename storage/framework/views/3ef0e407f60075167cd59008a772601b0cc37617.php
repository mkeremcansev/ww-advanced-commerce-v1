        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="product-details-frame">
                    <h3 class="mb-5 text-center"><?php echo app('translator')->get('words.payment_method', ['method'=>$method->title]); ?></h3>
                    <div class="row">
                        <div class="col-lg-6">
                                    ...
                                    <a class="details-wish wish w-100 custom-cursor-pointer" id="go-to-payment">
                                        <i class="icofont-arrow-right"></i>
                                            <span>
                                                ...
                                                <?php if($method->price): ?> <?php echo app('translator')->get('words.plus_price', ['price'=>getMoneyOrder($method->price)]); ?> <?php endif; ?>
                                            </span>
                                    </a>
                                </div>
                            <?php else: ?>
                                <div class="details-action-group mt-4">
                                    <a class="details-wish wish w-100 custom-cursor-pointer" id="go-to-payment">
                                        <i class="icofont-arrow-right"></i>
                                        <span>
                                            <?php echo app('translator')->get('words.go_to_payment', ['price'=>getMoneyOrderShoppingCart(Cart::instance('cart')->subtotal())]); ?>
                                            <?php if($method->price): ?> <?php echo app('translator')->get('words.plus_price', ['price'=>getMoneyOrder($method->price)]); ?> <?php endif; ?>
                                        </span>
                                    </a>
                                </div>
