                                ...
                                <div class="row">
                                    <div class="col-md-4 col-6">
                                        ...
                                        <a href="javascript:void(0)">
                                            <img width="150" src="<?php echo e(asset(setting('logo'))); ?>"
                                    ...
                                    <div class="col-md-4 col-6">
                                        ...
                                        <a href="javascript:void(0)">
                                            <img width="20" src="<?php echo e(asset(setting('favicon'))); ?>"
                                                class="img-fluid rounded mb-1" />
                                        </a>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/eticaretim/resources/views/panel/general/setting/index.blade.php ENDPATH**/ ?>