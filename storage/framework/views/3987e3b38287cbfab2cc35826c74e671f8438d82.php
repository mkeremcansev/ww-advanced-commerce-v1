                                            ...
                                            <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="name"><?php echo app('translator')->get('words.name'); ?></label>
                                                            <input type="text" class="form-control" name="title" value="<?php echo e($product->getOneProductAttributes->title); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control ckeditor" name="description"><?php echo e($product->getOneProductAttributes->description); ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="col-md-3 col-6">
                                                                    <img width="220px" src="<?php echo e(asset($image->image)); ?>" class="img-fluid rounded mb-1"/>
                                                                        <div class="text-center">
                                                                            <a href="<?php echo e(route('panel.product.image.destroy', $image->id)); ?>" class="btn btn-danger waves-effect waves-float waves-light mb-1"><?php echo app('translator')->get('words.delete'); ?></a>
                                                                        </div>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/eticaretim/resources/views/panel/product/update/index.blade.php ENDPATH**/ ?>