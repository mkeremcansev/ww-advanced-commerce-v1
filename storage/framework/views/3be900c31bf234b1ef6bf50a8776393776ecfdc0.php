...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('words.payment_methods'); ?>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title"><?php echo app('translator')->get('words.payment_methods'); ?></h4>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo app('translator')->get('words.plus_price', ['price'=>getMoneyOrder($m->price)]); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                                <a class="dropdown-item text-success" href="<?php echo e(route('panel.method.edit', $m->id)); ?>"><?php echo app('translator')->get('words.edit'); ?></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('panel.layouts.extends', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eticaretim\resources\views/panel/method/index.blade.php ENDPATH**/ ?>