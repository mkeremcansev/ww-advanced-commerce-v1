...
function modeChange() {
  ...
  if (checked) {
    document.querySelector('#modeChange').classList.remove('light-layout');
    document.querySelector('#modeChange').classList.add('dark-layout');
  } else {
    document.querySelector('#modeChange').classList.remove('dark-layout');
    document.querySelector('#modeChange').classList.add('light-layout');
  }
}
