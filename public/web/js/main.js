$(window).on("scroll", (function () { $(this).scrollTop() > 130 ? $(".header-part").addClass("active") : $(".header-part").removeClass("active") })), $(window).on("scroll", (function () { $(this).scrollTop() > 700 ? $(".backtop").show() : $(".backtop").hide() })), $((function () { $(".dropdown-link").click((function () { $(this).next().toggle(), $(this).toggleClass("active"), $(".dropdown-list:visible").length > 1 && ($(".dropdown-list:visible").hide(), $(this).next().show(), $(".dropdown-link").removeClass("active"), $(this).addClass("active")) })) })), $(".nav-link").on("click", (function () { $(".nav-list li a").removeClass("active"), $(this).addClass("active") })), $(".header-cate, .cate-btn").on("click", (function () { $("body").css(""), $(".category-sidebar").addClass("active"), $(".category-close").on("click", (function () { $("body").css(""), $(".category-sidebar").removeClass("active"), $(".backdrop").fadeOut() })) })),
    $(".header-cart, .cart-btn").on("click", (function () { $("body").css(""), $(".cart-sidebar").addClass("active"), $(".cart-close").on("click", (function () { $("body").css(""), $(".cart-sidebar").removeClass("active"), $(".backdrop").fadeOut() })) })),
    $(".header-wish, .wishlist-btn").on("click", (function () { $("body").css(""), $(".wishlist-sidebar").addClass("active"), $(".wishlist-close").on("click", (function () { $("body").css(""), $(".wishlist-sidebar").removeClass("active"), $(".backdrop").fadeOut() })) })),
    $(".header-cart, .header-cate, .cart-btn, .cate-btn, .header-wish, .wishlist-btn").on("click", (function () { $(".backdrop").fadeIn(), $(".backdrop").on("click", (function () { $(this).fadeOut(), $("body").css(""), $(".nav-sidebar").removeClass("active"), $(".cart-sidebar").removeClass("active"), $(".wishlist-sidebar").removeClass("active"), $(".category-sidebar").removeClass("active") })) })),
    $(".coupon-btn").on("click", (function () { $(this).hide(), $(".coupon-form").css("display", "flex") })), $(".header-src").on("click", (function () { $(".header-form").toggleClass("active"), $(this).children(".fa-search").toggleClass("fa-times") })), $(".action-plus").on("click", (function () {
